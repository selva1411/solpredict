      ...
      >
        <div className="flex items-center space-x-2.5">
          ...
          <div>
            ...
            <p className="text-[10px] text-[#808495]">Instant ML conviction synthesis, swinging factors & base rates</p>
          </div>
        </div>
        ...
        <div className="px-5 pb-5 pt-1 space-y-4 border-t border-[#ffd89c]/15 text-xs font-mono">
          {!summary && !loading && (
            <div className="flex flex-col items-center justify-center py-4 space-y-3">
              <p className="text-[#808495] text-center text-[11px]">
          ...
          {summary && (
            <div className="space-y-3 animate-fade-in">
              <div className="p-3 rounded-lg bg-[#1A1C22] border border-[#ffd89c]/20 space-y-1">
                <div className="text-[9px] uppercase tracking-wider font-bold text-[#808495] flex items-center justify-between">
                  <span>AI Verdict</span>
                  <span className="text-[#22c55e]">{summary.confidenceLevel}</span>
                </div>
                <p className="text-xs text-[#F4F4F9] leading-relaxed font-sans">{summary.verdict}</p>
              </div>

              {summary.tradingActivity && (
                <div className="p-3 rounded-lg bg-[#1A1C22] border border-[#22c55e]/25 space-y-1">
                  <div className="text-[9px] uppercase tracking-wider font-bold text-[#808495] flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between text-[10px] font-mono text-[#d6c4ac]">
                    ...
                    <span className="text-[#4CAF50]">{summary.tradingActivity.yesVolume24h.toFixed(2)} SOL YES</span>
                    <span className="text-[#E4574A]">{summary.tradingActivity.noVolume24h.toFixed(2)} SOL NO</span>
                  </div>
                </div>
              )}

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                <div className="p-2.5 rounded-lg bg-[#1A1C22] border border-white/10/20 space-y-1">
                  <div className="text-[9px] text-[#808495] uppercase font-bold">Historical Base Rate</div>
                  <div className="text-[11px] text-[#ffd89c]">{summary.historicalBaseRate}</div>
                </div>
                <div className="p-2.5 rounded-lg bg-[#1A1C22] border border-white/10/20 space-y-1">
                  <div className="text-[9px] text-[#808495] uppercase font-bold">Strategy Hint</div>
                  <div className="text-[11px] text-[#22c55e]">{summary.recommendation}</div>
                </div>
              </div>

              <div className="space-y-1 pt-1">
                <div className="text-[9px] uppercase tracking-wider font-bold text-[#808495]">Key Swinging Factors</div>
